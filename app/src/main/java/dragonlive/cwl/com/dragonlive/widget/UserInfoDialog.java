...
public class UserInfoDialog extends TransParentDialog {
    ...
    public void bindDataToViews(TIMUserProfile userInfo) {


        String avatarUrl = userInfo.getFaceUrl();
        if (!TextUtils.isEmpty(avatarUrl)) {
            GlideUtil.loadImageCircle(mActivity,avatarUrl,user_avatar,35);
        } else {
            GlideUtil.loadLocalImageCircle(mActivity,R.drawable.default_avatar,user_avatar,35);
        }
