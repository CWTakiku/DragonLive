...
public class ChatMsgInfo {
    ...
    //创建列表消息
    public static ChatMsgInfo createListInfo(String text, String userId, String avatar,String senderName) {
        ChatMsgInfo chatMsgInfo = new ChatMsgInfo();
        chatMsgInfo.msgType = MSGTYPE_LIST;
        chatMsgInfo.text = text;
        chatMsgInfo.senderId = userId;
        chatMsgInfo.avatar = avatar;
        chatMsgInfo.senderName = senderName;

        return chatMsgInfo;
    }

    public static ChatMsgInfo createDanmuInfo(String text, String userId, String avatar) {
        ChatMsgInfo chatMsgInfo = new ChatMsgInfo();
        chatMsgInfo.msgType = MSGTYPE_DANMU;
        chatMsgInfo.text = text;
        chatMsgInfo.senderId = userId;
        chatMsgInfo.avatar = avatar;
